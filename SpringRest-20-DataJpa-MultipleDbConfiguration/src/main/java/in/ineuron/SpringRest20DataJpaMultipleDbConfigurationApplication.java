...
public class SpringRest20DataJpaMultipleDbConfigurationApplication implements CommandLineRunner {
	@Autowired
	...
	public static void main(String[] args) {
		SpringApplication.run(SpringRest20DataJpaMultipleDbConfigurationApplication.class, args);
	}
